 ...
 * during that week of the current term. Weeks are 0-based from term start
 * ("Week 0" = the first seven days). Non-week rows (e.g. "New family enrols")
 * are guidance only.
 */
...
export const DEFAULT_CADENCE = `Week 0 (term start) | Term Start | Confirm classes + invoice. Add one line: "Ask us about referral & sibling discounts."
...
/** 0-based week number of the current term for a given date. */
