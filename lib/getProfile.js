...
export async function getAuthProfile() {
  // getSession() restores + refreshes the session from local storage; getUser()
  // only network-validates and returns null on any stale token, which bounced
  // home-screen PWAs to login on every cold start.
