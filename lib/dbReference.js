...
export const REFERENCE_TABLES = {
  ...
  // Directors teach too — they hold classes and shifts like any tutor — so they
  // belong in the explorer's teacher pickers alongside tutors. They live in
  // their own table because their pay and permissions differ, not because they
  // are not teaching staff.
  directors:{ select: 'id, full_name, email', label: 'full_name', secondary: ['email'] },
