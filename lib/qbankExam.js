...
function coverPage(meta, sections, totalMarks, solutions) {
  ...
  page.innerHTML =
    `<div style="position:absolute;top:64px;right:72px;width:420px">
     ...
     <div style="font-size:46px;font-weight:400;line-height:1.32;margin-top:34px;letter-spacing:-.5px">Year ${esc(meta.yearLabel) || 'XX'} ${meta.paperType === 'english' ? 'English' : 'Mathematics'}<br/>Term ${esc(meta.term) || 'XX'} Exam</div>
