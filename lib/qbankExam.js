 ...
 */
function coverKindLabel(meta) {
  const term = esc(meta.term) || 'XX'
  if (meta.kind === 'mock') return 'Mock Examination'
  if (meta.kind === 'mid_term') return `Term ${term} Mid-Term Exam`
  return `Term ${term} Exam`
}
