...
export const REPORT_KINDS = [
  {
    ...
    // The mid-term test's per-topic analytics belong on this report, exactly
    // as the term test's belong on the end-of-term one.
    showExam: true,
    examKind: 'mid_term',
    examLabel: 'Mid-term test analytics',
    showPrePost: false,
