 ...
 * database holds only "Linear Relationships 3". The Master Database has shown
 * names this way all along, so anything that copies a booklet's name into
 * another record (a builder draft, say) must use this, or the code silently
 * disappears the moment the copy is made.
 */
