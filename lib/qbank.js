...
//           subtopicsByTopic, skillsBySubtopic, skillsByTopic }.
// skillsByTopic is kept (skills still carry topic_id) so callers that only need
// topic-level grouping — and the topic-level exam analysis — work unchanged.
export async function fetchTaxonomy() {
  ...
  return {
    ...
    topicsBySubject, subtopicsByTopic, skillsBySubtopic, skillsByTopic,
  }
}
