...
/** Payments need accounting.transactions; invoices push fine without it. */
export const PAYMENTS_SCOPE = 'accounting.transactions'
...
async function xeroFetch(path, { method = 'GET', body } = {}) {
  ...
  // accounting.transactions. Say which one it is; "Unauthorized" alone sends
