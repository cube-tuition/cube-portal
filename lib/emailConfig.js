...
// The address families should reach us on — used for "get in touch" / mailto
// links inside outbound emails. This is the public-facing inbox, deliberately
// NOT the PORTAL_BCC archive address. Email templates are also rendered in the
// browser for the preview pages, so the override must be NEXT_PUBLIC_ to
// resolve the same on both sides.
export const CONTACT_EMAIL = process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'admin@cubetuition.com.au'
