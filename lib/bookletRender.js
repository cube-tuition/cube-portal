...
// `kicker` puts a labelled pill above the subject name (the worksheet cover
// uses "Additional Questions"); it merges with the Solutions pill on an
// answer-key copy so the cover never shows two badges.
export function coverHtml(meta = {}, { solutions, kicker } = {}) {
  ...
  return `<div class="bk-cv" style="--accent:${accent}">
    ...
    <div class="bk-cv-subject">
      ${kicker ? `<div class="bk-cv-soln">${esc(kicker)}${solutions ? ' · Solutions' : ''}</div>`
