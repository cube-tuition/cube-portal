...
export const BLOCK_TYPES = [
  ...
  { type: 'formula',    label: 'Formula box', icon: 'ƒ', group: 'Callouts' },
  { type: 'note',       label: 'Note box', icon: '▤', group: 'Callouts' },
  { type: 'definition', label: 'Definition box', icon: '§', group: 'Callouts' },
  { type: 'text',       label: 'Explanation', icon: '¶', group: 'Teaching' },
  { type: 'question', label: 'Question', icon: '✎', group: 'Questions' },
  { type: 'mcq',      label: 'MCQ', icon: '◉', group: 'Questions' },
  { type: 'mcqtable', label: 'MCQ answer table', icon: '▦', group: 'Questions' },
  { type: 'writing',  label: 'Writing space', icon: '≣', group: 'Questions' },
]
...
export function blockHtml(b, ctx) {
  switch (b.type) {
    ...
    case 'note':
      return calloutBlock('note', b.title || 'Note', rich(b.body), 'bk-callout-white')
    case 'definition':
...
const COVER_BG_SVG = `<svg viewBox="0 0 794 1123" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
  <line x1="72" y1="150" x2="722" y2="150" stroke="#e6ecf8" stroke-width="1.5"/>
  <circle cx="812" cy="92" r="236" fill="#EFF4FC"/>
  <circle cx="812" cy="92" r="236" fill="none" stroke="#dde6f7" stroke-width="1.5"/>
  <circle cx="812" cy="92" r="168" fill="none" stroke="#cfdaf1" stroke-width="1.5"/>
</svg>`
...
const COVER_LOGO = cubeMark('#364466')
...
.bk-cover-logo{ position:absolute; left:72px; top:84px; z-index:2; display:flex; align-items:center; gap:12px; }
.bk-cover-mark{ height:44px; display:inline-flex; }
.bk-cover-mark svg{ height:100%; width:auto; display:block; }
.bk-cover-wordmark{ font-size:15px; letter-spacing:.4em; color:#364466; font-weight:800; }
.bk-cover-main{ position:absolute; left:72px; right:72px; top:312px; z-index:2; text-align:left; }
.bk-cover-kicker{ font-size:12px; letter-spacing:.4em; text-transform:uppercase; color:#9babd0; font-weight:700; margin-bottom:20px; }
.bk-cover-subject{ font-size:96px; font-weight:800; color:var(--blue); line-height:.96; letter-spacing:-0.025em; }
.bk-cover-rule{ height:3px; width:96px; background:linear-gradient(90deg,#5b7bc4,#a8beec); margin:30px 0; border-radius:2px; }
.bk-cover-meta{ display:flex; align-items:center; gap:14px; font-weight:300; }
.bk-cover-year{ font-size:32px; color:#2a2035; }
.bk-cover-dot{ font-size:14px; color:#a8beec; }
.bk-cover-topic{ font-size:32px; font-weight:600; color:#5b7bc4; }
.bk-cover-name{ position:absolute; left:72px; bottom:100px; z-index:2; display:flex; align-items:flex-end; gap:12px; font-size:16px; color:#2a2035; }
.bk-cover-name span:first-child{ font-weight:600; }
.bk-cover-nameline{ display:inline-block; width:280px; border-bottom:1.5px solid #c2cce0; height:13px; }
.bk-cover-foot{ position:absolute; left:72px; bottom:60px; z-index:2; font-size:11px; letter-spacing:.26em; text-transform:uppercase; color:#aab3c6; font-weight:600; }
/* Section header */
