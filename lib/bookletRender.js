...
export function newBlock(type) {
  ...
  switch (type) {
    ...
    case 'table':    return { ...base, headerRow: false, headerCol: false, width: '', align: '', colWidths: [], rows: [['', '', ''], ['', '', ''], ['', '', '']] }
...
function tableHtml(b, embedded = false, ctx = null) {
  ...
  return `<div class="${wrapCls}"><table class="bk-tbl"${style}>${colgroup}${head}${body}</table></div>`
}
