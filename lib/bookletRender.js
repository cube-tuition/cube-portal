...
export function bookletRenderItems(blocks, { solutions, meta } = {}) {
  ...
  // Maths booklets don't print the syllabus band under section headings.
  const hideSectionSyllabus = /maths/i.test(meta?.subject || '')
  ...
  for (const b of content) {
    ...
    items.push({ html: blockHtml(b, { solutions, qNum: qn, hideSectionSyllabus }), pageBreakBefore: pendingBreak })
    pendingBreak = false
  }
