...
export function levelTestCoverHtml(meta = {}, { solutions } = {}) {
  ...
  const instructions = Array.isArray(cover.instructions) && cover.instructions.length ? cover.instructions : DEFAULT_LT_INSTRUCTIONS
  ...
  return `<div class="bk-lt">
    ...
    <div class="bk-lt-brand">
      ...
      <span class="bk-lt-word">CUBE Tuition</span>
    </div>
    ...
    <table class="bk-lt-marker">
      <thead><tr><th>Total mark</th><th>Comment from marker</th></tr></thead>
...
.bk-lt-title{ font-size:46px; font-weight:500; line-height:1.14; margin:34px 0 0; color:#1c1c1c; letter-spacing:-.5px; }
.bk-lt-info{ margin-top:46px; }
.bk-lt-row{ display:grid; grid-template-columns:150px 1fr; column-gap:24px; margin-bottom:34px; }
.bk-lt-lbl{ font-weight:700; font-size:16px; line-height:1.5; }
