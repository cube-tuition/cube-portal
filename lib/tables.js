...
export const T_STUDENT_WORKSHEETS = 'student_worksheets'
...
export const T_EMAIL_TEMPLATE_OVERRIDES = 'email_template_overrides'
export const T_EMAIL_REPORT_EXCLUSIONS  = 'email_report_exclusions'
export const T_COURSE_OFFERS            = 'course_offers'
export const T_HOLIDAY_COURSE_EMAILS    = 'holiday_course_emails'
export const T_FORMS                    = 'forms'
export const T_FORM_SUBMISSIONS         = 'form_submissions'
...
export const T_STUDENT_FLAGS      = 'student_flags'

// ── Content ───────────────────────────────────────────────────────────────────
export const T_BOOKLETS           = 'booklets'
export const T_BOOKLET_BUILDS     = 'booklet_builds'
// Holiday-course workbooks, planned by (holiday period, year, subject, day).
export const T_HOLIDAY_BOOKLETS   = 'holiday_booklets'
...
export const T_TEACHER_AVAILABILITY = 'teacher_availability'
...
export const T_CASH_LOG           = 'cash_log'
export const T_CASH_PAY_STATUS    = 'cash_pay_status'
export const T_DIRECTOR_BALANCES  = 'director_balances'
...
export const T_QBANK_SUBTOPICS       = 'qbank_subtopics'
...
export const T_QBANK_EXAMS            = 'qbank_exams'
export const T_QBANK_EXAM_SECTIONS    = 'qbank_exam_sections'
export const T_QBANK_EXAM_SLOTS       = 'qbank_exam_slots'
export const T_QBANK_RUBRICS          = 'qbank_rubrics'
export const T_QBANK_WORKSHEET_USAGE  = 'qbank_worksheet_usage'
export const T_QBANK_WORKSHEETS       = 'qbank_worksheets'
export const QBANK_BUCKET            = 'qbank-images'
export const T_SYLLABUS_MODULES       = 'syllabus_modules'
export const T_SYLLABUS_TOPICS        = 'syllabus_topics'
export const T_SYLLABUS_DOTPOINTS     = 'syllabus_dotpoints'
