  ...
  return (
    <div className="min-h-screen bg-[#F8FAFF]">
      ...
      <div className="max-w-5xl mx-auto px-6 pt-10 pb-16">
        ...
        {/* Year / course pages. Each opens a page listing that year's topics,
            with Workbooks and Additional Questions scoped to it. */}
        {tabs.length > 0 && (
          <div className="mb-8">
            <h2 className="text-[10px] font-bold tracking-widest uppercase text-[#325099]/60 mb-2.5">By year / course</h2>
            <div className="flex flex-wrap gap-1.5">
              {tabs.map((t) => (
                <Link key={t.key} href={`/tutor/resources/${slug}/materials/${t.key}`}
                  className="px-3 py-1.5 rounded-full text-[11px] font-semibold border bg-white text-[#2A2035]/65 hover:text-[#2A2035] transition"
            ...
            <p className="text-[11px] text-[#2A2035]/45 mt-2">
              Each opens that year&rsquo;s topics, with the areas below scoped to it.
            </p>
          </div>
        )}
